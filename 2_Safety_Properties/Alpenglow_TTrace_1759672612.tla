---- MODULE Alpenglow_TTrace_1759672612 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1759672612.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1759672612.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([notarFallbackVotes |-> (0 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 1 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 2 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {})),delivered |-> (n1 :> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]} @@ n2 :> {[slot |-> -1, tag |-> "G"]} @@ n3 :> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]} @@ n4 :> {[slot |-> -1, tag |-> "G"]}),timeoutsArmed |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> FALSE),produced |-> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]},finalized |-> {[slot |-> -1, tag |-> "G"]},skipVotes |-> (0 :> {n2, n4} @@ 1 :> {} @@ 2 :> {}),skipFallbackVotes |-> (0 :> {n3} @@ 1 :> {} @@ 2 :> {}),notarizedBlocks |-> {[slot |-> -1, tag |-> "G"]},fastFinalized |-> {},timeoutsFired |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> FALSE),notarVotes |-> (0 :> ([slot |-> 0, tag |-> "A"] :> {n1, n3, n4} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 1 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 2 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {})),parentReady |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> FALSE),finalVotes |-> (0 :> (n1 :> [slot |-> 0, tag |-> "A"] @@ n2 :> [slot |-> -2, tag |-> "NONE"] @@ n3 :> [slot |-> 0, tag |-> "A"] @@ n4 :> [slot |-> 0, tag |-> "A"]) @@ 1 :> (n1 :> [slot |-> -2, tag |-> "NONE"] @@ n2 :> [slot |-> -2, tag |-> "NONE"] @@ n3 :> [slot |-> -2, tag |-> "NONE"] @@ n4 :> [slot |-> -2, tag |-> "NONE"]) @@ 2 :> (n1 :> [slot |-> -2, tag |-> "NONE"] @@ n2 :> [slot |-> -2, tag |-> "NONE"] @@ n3 :> [slot |-> -2, tag |-> "NONE"] @@ n4 :> [slot |-> -2, tag |-> "NONE"]))]),
    ([notarFallbackVotes |-> (0 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 1 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 2 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {})),delivered |-> (n1 :> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]} @@ n2 :> {[slot |-> -1, tag |-> "G"]} @@ n3 :> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]} @@ n4 :> {[slot |-> -1, tag |-> "G"]}),timeoutsArmed |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> FALSE),produced |-> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]},finalized |-> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]},skipVotes |-> (0 :> {n2, n4} @@ 1 :> {} @@ 2 :> {}),skipFallbackVotes |-> (0 :> {n3} @@ 1 :> {} @@ 2 :> {}),notarizedBlocks |-> {[slot |-> -1, tag |-> "G"], [slot |-> 0, tag |-> "A"]},fastFinalized |-> {},timeoutsFired |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> FALSE),notarVotes |-> (0 :> ([slot |-> 0, tag |-> "A"] :> {n1, n3, n4} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 1 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {}) @@ 2 :> ([slot |-> 0, tag |-> "A"] :> {} @@ [slot |-> 1, tag |-> "A"] :> {} @@ [slot |-> 2, tag |-> "A"] :> {})),parentReady |-> (0 :> TRUE @@ 1 :> FALSE @@ 2 :> FALSE),finalVotes |-> (0 :> (n1 :> [slot |-> 0, tag |-> "A"] @@ n2 :> [slot |-> -2, tag |-> "NONE"] @@ n3 :> [slot |-> 0, tag |-> "A"] @@ n4 :> [slot |-> 0, tag |-> "A"]) @@ 1 :> (n1 :> [slot |-> -2, tag |-> "NONE"] @@ n2 :> [slot |-> -2, tag |-> "NONE"] @@ n3 :> [slot |-> -2, tag |-> "NONE"] @@ n4 :> [slot |-> -2, tag |-> "NONE"]) @@ 2 :> (n1 :> [slot |-> -2, tag |-> "NONE"] @@ n2 :> [slot |-> -2, tag |-> "NONE"] @@ n3 :> [slot |-> -2, tag |-> "NONE"] @@ n4 :> [slot |-> -2, tag |-> "NONE"]))])
    >>
----
...
---- CONFIG Alpenglow_TTrace_1759672612 ----
CONSTANTS
    Nodes = { n1 , n2 , n3 , n4 }
    Honest = { n1 , n2 , n3 }
    Byzantine = { n4 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Oct 05 20:15:20 IST 2025